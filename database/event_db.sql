...
(2, 'Afsana Mimi Rity', '+123456789', 'mimirity@sample.com', 'Sample', 1, 1, 0, 1, '0000-00-00 00:00:00');
...
(1, 'Tiger Graden', 'Khulna', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 300),
(2, 'Hotel Castle Salam', 'Jessore', 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 250),
(3, 'CSS Ava Center', 'Dhaka', 'Lorem ipsum dolor sit amet, id has nostro vivendo, id per alii volutpat inciderint? Graece ornatus gubergren te quo, qui at oblique accusamus, id pro eros etiam conceptam! Ullum clita.', 280),
(4, 'Hotel Royal', 'Chittagong', 'Lorem ipsum dolor sit amet, id has nostro vivendo, id per alii volutpat inciderint? Graece ornatus gubergren te quo, qui at oblique accusamus, id pro eros etiam conceptam! Ullum clita.', 1000);
...
(1, 'Name test1', 'Sample', 'asdasd@gmail.com', '+18456-5455-55', 2, '1 night', '2021-10-28 17:00:00', 1);
